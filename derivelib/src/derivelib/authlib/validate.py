...
The identity type is a parameter.
    ...
    from derivelib.authlib import TokenValidate, AuthToken
...
class TokenValidate(ScopeEnricher):
    ...
    Generic over identity type — injects under identity_type key.
    The lookup function is user-provided: async (token_str) -> identity | None.
    ...
    identity_type: type
    lookup: Callable[..., Awaitable[object]]  # async (str) -> identity | None
