"""Generic domain errors — shared across all derivation dialects.

These are NOT CRUD-specific. Any pattern that works with entities
needs NotFound, AlreadyExists, InvalidData.

ProblemDetail follows RFC 7807 (Problem Details for HTTP APIs).

    from derivelib._errors import NotFound, AlreadyExists
...
# RFC 7807 Problem Detail JSON Schema — shared by crud.py and authlib/openapi.py
# JSON Schema is inherently heterogeneous: values are str | int | dict | list.
